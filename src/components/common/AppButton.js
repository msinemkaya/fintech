...
export default function AppButton({ className, primary, rounded, purple, dark, white, gray, children }){
  ...
  const finalClasses = classNames(className, 'font-bold flex items-center justify-center hover:scale-110 transition-all duration-500', {
    ...
    'w-8 h-8 rounded-full bg-primary-light text-primary-dark text-xs': rounded
  })
