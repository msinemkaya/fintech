...
export default function HeadingSection(){
  return(
    <AppSection className='py-8 h-nav-screen'>
        <GridBox className='md:grid-cols-2 gap-4 w-full grid-rows-1 h-full'>
          <FlexBox className='flex-col justify-center md:!items-start items-center text-center md:text-left'>
          ...
          <Img url={headerimage} className='object-fit h-full justify-self-end hidden md:block'/>
        </GridBox>
    </AppSection>
  );
}